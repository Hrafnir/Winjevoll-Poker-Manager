...
const DEFAULT_LAYOUT_SETTINGS = { leftBasisPercent: 60, logoBasisPercent: 40, blindsBasisPercent: 35 }; // Added defaults
...
// === 06e: LAYOUT SETTINGS FUNCTIONS (NEW) START ===
...
// === 06e: LAYOUT SETTINGS FUNCTIONS (NEW) END ===

// === 06f: THEME FAVORITES FUNCTIONS (NEW) START ===
function loadThemeFavorites() { return loadObject(THEME_FAVORITES_KEY, []); } // Default to empty array
...
// === 06f: THEME FAVORITES FUNCTIONS (NEW) END ===
